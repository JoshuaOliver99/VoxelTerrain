...
namespace SunnyValleyStudio
{
    public class PlayerMovement : MonoBehaviour
    {
        ...
        {
            // Note: "should probably be .normalized.x / 2"
        ...
        public void Walk(Vector3 movmentInput, bool runningInput)
        {
            Vector3 movementDirection = GetMovementDirection(movmentInput);
        ...
        private void ApplyGravityForce()
        {
            ...
            playerVelocity.y = Mathf.Clamp(playerVelocity.y, gravityValue, 10); // (10 here is max ascend speed)
        }
