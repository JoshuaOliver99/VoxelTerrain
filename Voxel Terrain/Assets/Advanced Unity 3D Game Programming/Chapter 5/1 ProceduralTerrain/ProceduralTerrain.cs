...
namespace AdvancedUnity3DGameProgramming
{
	...
	public class ProceduralTerrain : MonoBehaviour
	{
		...
		[Tooltip("When an edge transitions between a positive and negative value, it'll be marked as 'crossed'. When terrain becomes solid")]
		public float surfaceCrossValue = 0;
		[Tooltip("The sacle of the noise for input into the system")]
		public float noiseScaleFactor = 20;

		public float manualPoint1 = 0.5f;
		public float manualPoint2 = 1.0f;
		public float manualPoint3 = 0.5f;
		...
		void FillData(float xOrigin, float yOrigin, float zOrigin)
		{
			...
			data[12, 20, 12] = manualPoint1;
			data[13, 20, 12] = manualPoint2;
			data[14, 20, 12] = manualPoint3;
		}
	}
}